 ...
 * Este es quien envia el documento.
 * 
 ******************************************************************************/
    ...
    * */
    ...
    numPuerto = atoi(argumentos[2]);					// Se convierte argumento correspondiente a puerto a numero entero.
     while(1){
		char nombre[100];
		char *fs_name=nombre;
		printf("Digite la direccion del archivo: (Ej: /home/usuario/Escritorio/archivo.txt)\n");
		printf(">>> ");
		scanf("%s",fs_name);
    /*
    ...
    close(socketRemoto);	//En caso de que todo marche bien, cierre el puerto.
    return 0;
}
